...
let link = [
    './pages/BaiTapLon/buoi - 1/index.html',
    './pages/BaiTapLon/buoi - 2/index.html',
    './pages/BaiTapLon/buoi - 3/index.html',
    './pages/BaiTapLon/buoi - 4/index.html',
    './pages/BaiTapLon/buoi - 5/index.html',
    './pages/BaiTapLon/buoi - 6/index.html',
    './pages/BaiTapLon/buoi - 7/index.html',
    './pages/BaiTapLon/buoi - 8/index.html',
    './pages/BaiTapLon/buoi - 9/index.html',
    './pages/BaiTapLon/buoi - 10/index.html',
    './pages/BaiTapLon/buoi - 11/index.html',
    './pages/BaiTapLon/buoi - 12/index.html'
]
...
for(let i = 0; i < 12; i++){
    ...
    div.innerHTML = `
       <div class="imge help${i}">
                        ...
                        <a href="https://nguyenvan-trung.github.io/HIT-WEB-2024/BaiTapLon/buoi%20-%20${i+1}/index.html"><button>Thêm Vào Giỏ Hàng</button></a>
                    </div>
                    <h4>${note[i]}</h4>
